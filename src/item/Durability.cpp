...
//
// Exposed via [[item/Durability.h]] so `Container::Durability` can
// reuse the same descriptor read for `C_Container.GetContainerItemDurability`.
...
int __fastcall Script_GetInventoryItemDurability(void *L) {
